...
public class ItemBasedRecommenderRefreshTests extends AbstractRecommenderTest {

	private static final String DATA_SOURCE = "/Users/n.kazarian/Projects/hackathon/data/small/result.csv";
...
//		recommender.refresh(null);
		setup();
		recommender = builder.refresh(model);
	...
	public void evaluate() throws Exception {
		...
		RecommenderBuilder builder = new RecommenderBuilder() {
			...
			public Recommender buildRecommender(DataModel arg0) throws TasteException {
				return ItemBasedRecommenderRefreshTests.this.builder.getRecommender(arg0);
			}
		};
